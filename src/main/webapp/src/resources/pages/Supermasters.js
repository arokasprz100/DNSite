...
class Table extends React.Component {
  ...
  deleteSupermaster = (ip, nameserver) => {
    let self = this;
    let URI =
      "http://localhost:8001/supermasters/delete/" + ip + "/" + nameserver;
    fetch(URI)
            ...
            <button
              onClick={() => {
                this.deleteSupermaster(
                  original.supermasterId.ip,
                  original.supermasterId.nameserver
                );
              }}
            >
              {" "}
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <button
                  className="btn btn-lg btn-primary btn-block"
                  onClick={e => this.handleNewSupermasters(e)}
                >
                  Submit
                </button>
              </td>
