    ...
    <form:form method="POST" modelAttribute="userForm" class="form-signin RegistrationForm">
        ...
        <spring:bind path="hostname">
            <div class="form-group ${status.error ? 'has-error' : ''}"
                ...
                <form:input type="text" path="hostname" class="form-control RegistrationControl"
        ...
        <spring:bind path="dbPort">
            <div class="form-group ${status.error ? 'has-error' : ''}"
                 style="display:${(isNotFirstUser)?'none':'block'}">
                <form:input type="text" path="dbPort" class="form-control RegistrationControl"
        ...
        <spring:bind path="database">
            <div class="form-group ${status.error ? 'has-error' : ''}"
                 style="display:${(isNotFirstUser)?'none':'block'}">
                <form:input type="text" path="database" class="form-control RegistrationControl"
        ...
        <spring:bind path="powerAdminPassword">
            <div class="form-group ${status.error ? 'has-error' : ''}"
                 style="display:${(isNotFirstUser)?'none':'block'}">
                <form:input type="text" path="powerAdminPassword" class="form-control RegistrationControl"
        ...
        <spring:bind path="powerAdminUsername">
            <div class="form-group ${status.error ? 'has-error' : ''}"
                 style="display:${(isNotFirstUser)?'none':'block'}">
                <form:input type="text" path="powerAdminUsername" class="form-control RegistrationControl"
        ...
        <spring:bind path="hostmaster">
            <div class="form-group ${status.error ? 'has-error' : ''}"
                 style="display:${(isNotFirstUser)?'none':'block'}">
                <form:input type="text" path="hostmaster" class="form-control RegistrationControl"
        ...
        <spring:bind path="primaryNameServer">
            <div class="form-group ${status.error ? 'has-error' : ''}"
                 style="display:${(isNotFirstUser)?'none':'block'}">
                <form:input type="text" path="primaryNameServer" class="form-control RegistrationControl"
        ...
        <spring:bind path="secondNameServer" >
            <div class="form-group ${status.error ? 'has-error' : ''} "
                 style="display:${(isNotFirstUser)?'none':'block'}">
                <form:input type="text" path="secondNameServer" class="form-control RegistrationControl"
